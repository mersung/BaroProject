...
class DiskChange(models.Model):
    ...
    disk_path = models.ForeignKey('DiskFixed', models.DO_NOTHING, db_column='disk_path')
    ip = models.ForeignKey('DiskFixed', models.DO_NOTHING, db_column='ip')
...
class GpuChange(models.Model):
    ...
    gpu_index = models.ForeignKey('GpuFixed', models.DO_NOTHING, db_column='gpu_index')
    ip = models.ForeignKey('GpuFixed', models.DO_NOTHING, db_column='ip')
